...
export const Hero: React.FC = () => {
  ...
  const handleWhatsAppClick = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.stopPropagation();
    window.open(`https://wa.me/${SHOP_PHONE_NUMBER}`, '_blank', 'noopener,noreferrer');
  };
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 py-12 md:py-20">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            {/* Description */}
            <p className="text-sm md:text-lg text-blue-100 mb-8 max-w-lg mx-auto md:mx-0">
              {t('hero.description')}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link 
                to="/products" 
                className="inline-block bg-white text-blue-600 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold text-lg transition-all duration-200 cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-block border-2 border-white text-white hover:bg-white/20 px-6 py-3 rounded-lg font-semibold text-lg transition-all duration-200 cursor-pointer"
              >
                <span className="flex items-center justify-center gap-2">
                  {t('hero.chatNow')}
                </span>
